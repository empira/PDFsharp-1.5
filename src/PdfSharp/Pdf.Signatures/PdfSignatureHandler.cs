...
namespace PdfSharp.Signatures
{
    ...
    public class PdfSignatureHandler
    {
        ...
        private const int signatureLengthAprox = 1000; // aproximative maximum length value
        ...
        public PdfSignatureHandler(X509Certificate2 certificate, PdfSignatureOptions options)
        {            
            this.Certificate = certificate;
            this.Options = options;
            maximumSignatureLength = certificate.Export(X509ContentType.Cert).Length + signatureLengthAprox;
        }
        ...
        private void AddSignatureComponents(object sender, EventArgs e)
        {
            ...
            var paddedContents = new PdfString("", PdfStringFlags.HexLiteral, maximumSignatureLength);
